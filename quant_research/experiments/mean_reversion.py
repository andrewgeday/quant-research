...
from quant_research.strategies import MeanReversionStrategy
...
def run() -> None:
    """
    Run the mean reversion strategy experiment.

    This function loads configuration, runs the data pipeline, generates mean reversion signals,
    ...
    try:
        ...
        logger.error(f"Error running mean reversion experiment: {e}")
        raise
